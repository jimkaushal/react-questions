# react-questions
Best React Interview Questions & Answers
...
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     | **Core React**                                                                                                                                                                                                                   |
| 1   | [What is React?](#what-is-react [E])                                                                                                                                                                                                 |
| 2   | [What are the major features of React?](#what-are-the-major-features-of-react [M])                                                                                                                                                   |
| 3   | [What is JSX?](#what-is-jsx [A])                                                                                                                                                                                                     |
| 4   | [What is the difference between Element and Component?](#what-is-the-difference-between-element-and-component [M])                                                                                                                   |
| 5   | [How to create components in React?](#how-to-create-components-in-react [E])                                                                                                                                                         |
| 6   | [When to use a Class Component over a Function Component?](#when-to-use-a-class-component-over-a-function-component [M])                                                                                                             |
| 7   | [What are Pure Components?](#what-are-pure-components [A])                                                                                                                                                                           |
| 8   | [What is state in React?](#what-is-state-in-react [E])                                                                                                                                                                               |
| 9   | [What are props in React?](#what-are-props-in-react [E])                                                                                                                                                                             |
| 10  | [What is the difference between state and props?](#what-is-the-difference-between-state-and-props [M])                                                                                                                               |
| 11  | [Why should we not update the state directly?](#why-should-we-not-update-the-state-directly [A])                                                                                                                                     |
| 12  | [What is the purpose of callback function as an argument of setState()?](#what-is-the-purpose-of-callback-function-as-an-argument-of-setstate [A])                                                                                   |
